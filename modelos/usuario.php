    ...
    class cateroria extends Modelo{
        ...
        */
        ...
        public function store($data){//array[]
            $consulta = "INSERT INTO $this->nombre_tabla (usu_usr,usu_password,usu_nombres,usu_primer_apellido,usu_segundo_apellido,usu_descripcion_usuario,usu_descripcion_contacto) values ('".$data['cat_nombre']."');";
            $resultado = $this->db->query($consulta);
            if(!$resultado){
